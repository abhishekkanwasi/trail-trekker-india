...
if(isset($_POST['email'])) {
    ...
    $email_to = "info@trailtrackerindia.com";
    $email_subject = "Form Submission Kedarkantha Trek";
...
<div class="container">
	<div class="row text-center">
        ...
        <a href="https://fusejack.in/TTI/trailtrekkerindia.com/kedarkantha.html" class="btn btn-success">     Read More      </a>
    <br><br>
        </div>
