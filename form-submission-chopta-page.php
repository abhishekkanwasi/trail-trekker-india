...
if(isset($_POST['email'])) {
    ...
    $email_subject = "Form Submission Chopta Trek (Page)";
...
<div class="container">
	<div class="row text-center">
        ...
        <a href="https://www.trailtrekkerindia.com/chopta-chandrashila-tungnath-deoriatal-trek.html" class="btn btn-success">     Read More      </a>
    <br><br>
        </div>
